...
def search_post(keywords, since, until, data, keyword_type):
        for keyword in keywords:
                ...
                for post in posts:
                        ...
                        # -----在特定時間範圍的貼文才紀錄
                        if postdate > until:
                                print("Post date not satisfied, post abandoned.")
                                print("--------------------------------------------")
                                continue
                        elif postdate < since:
                                # -----------------------------------------------
                                # /   用k值檢查確保不是突然有一篇很舊的貼文出現   /
                                # /   需要連續20篇舊貼文才會停止迴圈             /
                                # ----------------------------------------------
                                print("Post date not satisfied, post abandoned.")
                                print("--------------------------------------------")
                                ...
                                try :
                                        ...
                                        ###############################################
                                                ...
                                                print("No location, post abandoned.")
                                                print("--------------------------------------------")
                                        ###############################################
                                        ...
                                        print(" 429 Too many requests, end of program.")
...
# -----設定特定時間貼文-----
since = datetime(2021, 12, 12) #起始日期
until = datetime(2021, 12, 22) #結束日期(不包含)
