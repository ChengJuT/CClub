...
xmas_map2 = folium.Map(location = [24.199098,120.6820908],  #參考座標位置,會位於地圖的中心位置
...
marker_cluster = MarkerCluster(name = "Xmas Place_Layer").add_to(xmas_map2)
food = MarkerCluster(name = "Food_Layer").add_to(xmas_map2)
...
xmas_map2.add_child(marker_cluster)
xmas_map2.add_child(food)

folium.LayerControl().add_to(xmas_map2)

### 存檔
xmas_map2.save('xmas_map2.html')
